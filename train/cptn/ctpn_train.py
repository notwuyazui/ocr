...
import config
from train.cptn.ctpn_train import CTPN_Model, RPN_CLS_Loss, RPN_REGR_Loss
from data.dataset import CH4Dataset
...
if __name__ == '__main__':
    ...
    dataset = CH4Dataset(config.ch4_mlt_img_dir, config.ch4_mlt_gt_dir)
